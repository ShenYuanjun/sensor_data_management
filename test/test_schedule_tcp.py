...
async def start_async_test_env(collection, clients):
...
if __name__ == '__main__':
    ...
    new_loop, client1 = ModbusClient(schedulers.ASYNC_IO, host='192.168.1.82', port=1030, loop=loop, framer=ModbusFramer)
    new_loop, client2 = ModbusClient(schedulers.ASYNC_IO, host='192.168.1.82', port=1031, loop=loop, framer=ModbusFramer)
    new_loop, client3 = ModbusClient(schedulers.ASYNC_IO, host='192.168.1.82', port=1032, loop=loop, framer=ModbusFramer)
    new_loop, client4 = ModbusClient(schedulers.ASYNC_IO, host='192.168.1.82', port=1033, loop=loop, framer=ModbusFramer)
    new_loop, client5 = ModbusClient(schedulers.ASYNC_IO, host='192.168.1.82', port=1034, loop=loop, framer=ModbusFramer)
